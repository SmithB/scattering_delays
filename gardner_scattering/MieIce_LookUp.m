function [qext0, qsca0, g0] = MieIce_LookUp(r0, WL0)
%% Mie qext qsca g look-up function for ice 
% Alex S. Gardner, JPL/NASA
% Look up parameters
...
if r0 > max(r) || r0 < min(r)
    error('effective grain radius r is out of MieIce_LookUp range')
elseif nargin == 2 
    if WL0 > max(WL) || WL0 < min(WL)
     error('wavelength WL is out of MieIce_LookUp range')
    end
end
